...
import dev.hytalemodding.impulse.core.internal.physics.PhysicsStoreRuntimeCleaner;
...
final class PhysicsStoreCrucibleSupport {
    ...
    static Ref<PhysicsStore> addBody(@Nonnull Store<PhysicsStore> store,
        ...
        return store.addEntity(PhysicsBodyEntities.bodyHolder(spaceRef,
            bodyUuid,
            bodyCenter,
            shape,
            bodyType,
            mass,
            settings,
            linearVelocity), AddReason.SPAWN);
    }
