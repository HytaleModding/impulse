...
import dev.hytalemodding.impulse.core.internal.modules.physicschunk.ShapeTemplateCache.ShapeTemplate;
...
final class SectionBlockReader {
    ...
    @Nullable
    private final PhysicsChunkSectionAccessCache accessCache;
