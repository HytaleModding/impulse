...
class ImpulseRegistryTest {
    ...
    void registersBackendsInitializesOnceAndPreservesRequestedSpaceId() {
        ...
        assertEquals(new SpaceId(12345), secondSpace.getId());
        assertEquals(backend.getId(), firstSpace.getBackendId());
    ...
    private static final class FakePhysicsSpace implements PhysicsSpace {
