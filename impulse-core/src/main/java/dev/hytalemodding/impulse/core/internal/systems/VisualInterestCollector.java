 ...
 */
final class VisualInterestCollector {
    ...
    @Nonnull
    static List<PhysicsSyncPolicy.PlayerInterest> collectSyncInterests(@Nonnull Store<EntityStore> store) {
    ...
    @Nonnull
    static List<PhysicsWorldResource.VisualInterest> collectMaterializationInterests(
