...
public class PhysicsVisualSyncSettings {
    ...
    public void setVisualFullSyncRadius(int visualFullSyncRadius) {
        int boundedVisualFullSyncRadius = PhysicsEntitySettingsValidation.requirePositiveAtMost(
    ...
    public void setVisualMaxSyncRadius(int visualMaxSyncRadius) {
        int boundedVisualMaxSyncRadius = PhysicsEntitySettingsValidation.requirePositiveAtMost(
    ...
    public void setVisualMidSyncIntervalTicks(int visualMidSyncIntervalTicks) {
        this.visualMidSyncIntervalTicks = PhysicsEntitySettingsValidation.requirePositiveAtMost(
    ...
    public void setVisualFarSyncIntervalTicks(int visualFarSyncIntervalTicks) {
        this.visualFarSyncIntervalTicks = PhysicsEntitySettingsValidation.requirePositiveAtMost(
    ...
    public void setVisualOcclusionRaycastsPerTick(int visualOcclusionRaycastsPerTick) {
        this.visualOcclusionRaycastsPerTick = PhysicsEntitySettingsValidation.requirePositiveAtMost(
    ...
    public void setVisualOcclusionCacheTicks(int visualOcclusionCacheTicks) {
        this.visualOcclusionCacheTicks = PhysicsEntitySettingsValidation.requirePositiveAtMost(
